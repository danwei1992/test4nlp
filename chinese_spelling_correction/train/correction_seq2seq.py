...
vocab_path = './resources/chinese_L-12_H-768_A-12/vocab.txt'

train_data = json.load(open('./resources/chinese_spelling_correction_pretrain/data/train_data.json', 'r', encoding='utf-8'))
valid_data = json.load(open('./resources/chinese_spelling_correction_pretrain/data/valid_data.json', 'r', encoding='utf-8'))
...
class MyDataGenerator(DataGenerator):
    def __iter__(self, random=True):
        ...
        for is_end, D in self.sample(random):
            ...
            token_ids, segment_ids = tokenizer.encode(first_text=wrong, second_text=right, maxlen=max_len * 2)
...
class Evaluator(Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        if logs['loss'] <= self.lowest:
            ...
            model.save('./resources/chinese_spelling_correction_pretrain/model/best_seq2seq_model.h5')
...
if __name__ == '__main__':
    ...
    print("加载模型")
    model.load_weights('./resources/chinese_spelling_correction_pretrain/model/best_seq2seq_model.h5')
    print("模型加载完毕")
